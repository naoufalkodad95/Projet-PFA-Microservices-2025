...
import { FaRegCalendarCheck, FaMoneyCheckAlt, FaBell } from 'react-icons/fa';
...
const SectionTitle = styled.h3`
  ...
  color: ${props => props.darkMode ? '#999' : '#9e9e9e'};
...
const SidebarLink = styled(NavLink)`
  ...
  &.active {
    background-color: ${props => props.collapsed
    ? (props.darkMode ? '#333' : '#e8f5e9')
    : 'transparent'};
    color: #25A55F;
    border-left: ${props => props.collapsed
    ? 'none'
    : '3px solid #25A55F'};
...
const SidebarIcon = styled.div`
  ...
  color: ${props => props.darkMode ? '#e0e0e0' : '#666'};
`;
            ...
            <SidebarNav collapsed={sidebarCollapsed}>
              <SidebarSection>
                ...
                >
                  ...
                  <SidebarText collapsed={sidebarCollapsed ? 1 : 0}>
                    Tableau de bord
                  </SidebarText>
                </SidebarLink>
              </SidebarSection>
              ...
              <SidebarSection>
                ...
                >
                  ...
                  <SidebarText collapsed={sidebarCollapsed ? 1 : 0}>Réservations</SidebarText>
                </SidebarLink>
