// src/components/challenges/SentChallenges.jsx
...
const SentChallenges = ({ challenges = [], onCancel }) => {
        ...
        <TableBody>
          {sortedChallenges.length > 0 ? (
              sortedChallenges.map(challenge => (
                  <ChallengeRow key={challenge.id}>
                    <TeamName>{challenge.equipeAdverseNom}</TeamName>
              ...
              <EmptyMessage>Vous n'avez pas encore envoyé de défis.</EmptyMessage>
          )}
        </TableBody>
      </ChallengesTable>
  );
